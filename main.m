    ...
    for i=1:len2/(num_caregiver+1)
        ...
        for run=1:15 % run time
            ...
            while j<=generation
                ...
                population_muta=mutation(population_cross,distance,timewindow,servicetime,quality,depart,syn_points,worktime,num_caregiver,num_patient,num_syn,lunch_points);
                [population_search,value]=local_search(population_muta,distance,timewindow,servicetime,quality,depart,syn_points,worktime,num_caregiver,num_patient,num_syn,lunch_points);
